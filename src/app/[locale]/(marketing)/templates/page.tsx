...
> = {
  riviera: {
    gradient: "linear-gradient(160deg, #6B9CC3 0%, #4A7FA8 40%, #3A6F98 100%)",
    textColor: "text-white",
    mutedColor: "text-white/75",
    buttonClass:
      "bg-white text-[#3A6F98] hover:bg-white/90 border-0",
    badgeClass: "bg-white/20 text-white/90",
  },
  "la-dolce-vita": {
    gradient: "linear-gradient(160deg, #FFFCF5 0%, #FFF3D6 40%, #F5E6B8 100%)",
    textColor: "text-[#1B3A5F]",
    mutedColor: "text-[#5F7896]",
    buttonClass:
      "bg-[#1B3A5F] text-white hover:bg-[#152E4D] border-0",
    badgeClass: "bg-[#1B3A5F]/10 text-[#1B3A5F]/70",
  },
  bloementuin: {
    gradient: "linear-gradient(160deg, #F0EBE3 0%, #E2DDD2 40%, #D4CFBF 100%)",
    textColor: "text-[#3D3D3D]",
    mutedColor: "text-[#7A7A6E]",
    buttonClass:
      "bg-[#6B8F6B] text-white hover:bg-[#5A7E5A] border-0",
    badgeClass: "bg-[#6B8F6B]/15 text-[#6B8F6B]",
  },
  minimalist: {
    gradient: "linear-gradient(160deg, #FFFFFF 0%, #FAFAFA 40%, #F5F5F5 100%)",
    textColor: "text-[#2C2C2C]",
    mutedColor: "text-[#999999]",
    buttonClass:
      "bg-[#2C2C2C] text-white hover:bg-[#1A1A1A] border-0",
...
function TemplateCard({
  ...
  return (
    ...
    >
      <div
        className="group aspect-[3/4] rounded-2xl overflow-hidden relative flex flex-col justify-between p-5 sm:p-6 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 cursor-pointer"
